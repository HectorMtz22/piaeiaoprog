...
<body>
    ...
    <form class="form" method="POST">
        <h3>Insertar Ventas</h3>
        <main>
            <input type="number" name="idDetalles" placeholder="Auto-Incremento">
            <label htmlFor="idDetalles" className="label-name">
                <span className="content-name">idDetalles</span>
            </label>
        </main>
        <main>
...
if (isset($_POST['ok'])) {
    ...
    $detalles->post($idProducto, $idUsuario, $cantVenta, $fechaVenta, $totalVenta);
