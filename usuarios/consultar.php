...
<body>
    ...
    <a href='consultar.php'>Actualizar tabla...</a>
		<h1>Consulta de la tabla de usuarios </h1>
		<main class="grid-5">
			<section>Clave</section>     
			<section>Nombre</section>
			<section>Email</section>
			<section>Teléfono</section>
			<section>Contraseña</section>
			<?php
                require "../classes/classAdminUsuarios.php";
                $productos = new ApiUsuarios;
                ...
                foreach ($total["items"] as $clave => $valor) {
                    ...
                    print "<section>$valor[email]</section>";
                    print "<section>$valor[tel]</section>";
                    print "<section>$valor[contra]</section>";
                }
				print "</main>";
